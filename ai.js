...
const SPOT_DESCRIPTIONS = {
  ...
  "front-panel": "the front panel of the cap, centered above the brim — the FULL decoratable panel, spanning roughly half to two-thirds of the cap's visible width, the scale team caps actually carry their artwork at",
  "cap-side": "the side panel of the cap over the wearer's left temple",
  "beanie-cuff": "the turned-up cuff of the beanie, front center — the full front face of the cuff, roughly half the beanie's visible width",

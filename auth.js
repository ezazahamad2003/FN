...
const DEFAULT_ENV = {
  ...
  // Department Onboarding Agent (see docs/department-onboarding-agent.md).
  GDRIVE_OMNI_PRINTER_FOLDER_ID: "",
  DEPARTMENT_CODE_LIST_DOC_ID: "",
  LOCKSMITH_ACCESS_TOKEN: "",
  HELIUM_FORMS: "",
  SHOPIFY_STOREFRONT_DOMAIN: "",
  ONBOARDING_MOCKUP_SIZE: "",
  ONBOARDING_MOCKUP_VERIFY: "",
  PORT: "3456"
};
